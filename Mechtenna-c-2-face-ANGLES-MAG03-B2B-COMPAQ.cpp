...
bool Multiple_Angles = false;  // true; //false;//  true; // false;  //24sept2023 change...   true;// 22nov20 set true .. false; // true;  //  0;// 0;// 2jan2019changed  true;   //    0;		//0;     //   0;    // 1;  // 0;//  true ;
bool MAG03_display = false;    // true; //false;// true; //false;    //  true; //    false;   //22nov20 set false    true   true ;    //
...
double fixed_angle = PI/2; //0;//   PI/8; //   PI/20;//  PI/2;//PI/0; //8; //    0;		//PI/8; //        PI/2   ; //   0;  // only use if we aren't in Multiple_Angle calc mode
...
//bcc32 -Ic:\borland\BCC55\include -Lc:\borland\bcc55\lib -Lc:\borland\BCC55\psdk -Lc:\borland\bcc55\lib\psdk Mechtenna-c-2-face-ANGLES-MAG03-B2B-COMPAQ.cpp
