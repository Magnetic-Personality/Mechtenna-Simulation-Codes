...
bool Multiple_Angles = 0;// 1;//  1;// 1; //  0; //   true;// 22nov20 set true .. false; // true;  //  0;// 0;// 2jan2019changed  true;   //    0;		//0;     //   0;    // 1;  // 0;//  true ;
...
pB . x  =  turn_rad ;
pB . y  =  turn_y_first + .003;   //turn_y_last ;
pB . z  =  0 ;
...
//bcc32 -Ic:\borland\BCC55\include -Lc:\borland\bcc55\lib -Lc:\borland\BCC55\psdk -Lc:\borland\bcc55\lib\psdk Mechtenna--COMPAQ-Mar-21-E-elec.cpp
